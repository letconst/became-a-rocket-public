...
public partial class SoundManager
{
    ...
    private Dictionary<int, Audio> GetAudioDict(Audio.AudioType type)
    {
        return type switch
        {
    ...
    /// </summary>
    /// <returns></returns>
    private AudioSource GetFreeUISoundSource()
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Audio GetMusicAudio(int id)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Audio GetSoundAudio(int id)
    {
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Audio GetUISoundAudio(int id)
    {
    ...
    public Audio GetAudio(Audio.AudioType type, int id)
    {
    ...
    private bool IsSelfAudioSource(AudioSource target)
    {
